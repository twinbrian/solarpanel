...
//Set 1.5 seconds to give enough time for solar panel to settle in a new position before reading voltage output.
int trackerNewPositionSettleDelay = 1500;

//A pre-calibrated mapping btw analogRead value and the corresponding output voltage from tracker solar panel.
//This mapping is used to obtain the output voltage value based on the integer value read from analogRead()
...
//A pre-calibrated mapping btw analogRead value and the corresponding output voltage from baseline solar panel.
//This mapping is used to obtain the output voltage value based on the integer value read from analogRead()
//during data collection phase.
